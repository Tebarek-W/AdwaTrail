  ...
  return (
    <div className="flex min-h-screen bg-white">
      ...
      <div className="hidden lg:relative lg:flex lg:flex-1">
        <Image
          src="/images/lalibela_boutique_hotel_1773406077350.png"
          alt="Lalibela Boutique Hotel"
          fill
        ...
        <div className="absolute bottom-12 left-12 max-w-lg text-white">
          <Reveal>
            <h2 className="font-serif text-4xl font-bold leading-tight">
              Start your journey <br /> with Adwa Trail.
            </h2>
            <p className="mt-4 text-white/80">
              Join thousands of travelers exploring the rich history and unmatched landscapes of Ethiopia.
            </p>
          </Reveal>
        </div>
      </div>
        ...
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <Reveal>
            <div className="mb-10 text-center lg:text-left">
              ...
              <h2 className="mt-8 text-3xl font-bold tracking-tight text-foreground">Create an account</h2>
              <p className="mt-2 text-sm text-muted-foreground">
                Get ready to book incredible stays and experiences.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal delayMs={100} className="mt-10">
            ...
            <form className="space-y-5" onSubmit={handleRegister}>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground px-1">Must be at least 8 characters.</p>
              </div>
            ...
            <div className="mt-8">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="bg-white px-2 text-xs font-bold uppercase tracking-wider text-muted-foreground">Or sign up with</span>
                </div>
              </div>
            ...
            <p className="mt-10 text-center text-sm text-muted-foreground">
              ...
              <Link href="/login" className="font-bold text-adwa-gold hover:underline">
                Log in
              </Link>
            </p>
          </Reveal>
